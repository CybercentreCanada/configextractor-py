...
from configextractor.frameworks import CAPE, MACO, MALDUCK, MWCP

PARSER_FRAMEWORKS = [(MACO, "yara_rule"), (MWCP, "yara_rule"), (CAPE, "rule_source"), (MALDUCK, "yara_rules")]
    ...
    def __init__(self, parsers_dirs: list, logger: Logger = None, parser_blocklist=[]) -> None:
        ...
        for parsers_dir in parsers_dirs:
            ...
            for _, module_name, ispkg in pkgutil.walk_packages(mod.__path__, mod.__name__ + "."):
                ...
                if any([module_name.split(".")[-1] == np for np in not_py]):
